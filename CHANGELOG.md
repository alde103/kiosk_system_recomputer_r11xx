...
* Ported the reComputer overlays (reComputer-R110x, tpm-spi-slx9670, gpio-led,
  pca953x) into the new EEx-based `fwup.conf.eex`
* Retained the PCF8563W RTC driver, PCA953X GPIO expander and SMSC95XX USB
  Ethernet kernel options
